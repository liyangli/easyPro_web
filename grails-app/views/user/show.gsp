	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.flag}">
				<li class="fieldcontain">
					<span id="flag-label" class="property-label"><g:message code="user.flag.label" default="Flag" /></span>
					
						<span class="property-value" aria-labelledby="flag-label"><g:formatBoolean boolean="${userInstance?.flag}" /></span>
